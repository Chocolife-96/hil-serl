...
class EnvConfig(DefaultEnvConfig):
    ...
    REALSENSE_CAMERAS = {
        "wrist_1": {
            "serial_number": "235422301289",
            "dim": (1280, 720),
            "exposure": 40000,
        },
        "wrist_2": {
            "serial_number": "218622272279",
            "dim": (1280, 720),
            "exposure": 40000,
        },
    }
    IMAGE_CROP = {
        "wrist_1": lambda img: img[250:720, 500:1100],
        "wrist_2": lambda img: img[50:550, 350:950],
    }
...
class TrainConfig(DefaultTrainingConfig):
    ...
    def get_environment(self, fake_env=False, save_video=False, classifier=False):
        ...
        # env = RelativeFrame(env) # 这里面包含了step()重写
        # env = Quat2EulerWrapper(env) # 这里面包含了observation数据的重组
