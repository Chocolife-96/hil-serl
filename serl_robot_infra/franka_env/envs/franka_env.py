...
class DefaultEnvConfig:
    ...
    REALSENSE_CAMERAS: Dict = {
        "wrist_1":       "235422301289",  # D455
        "wrist_2": "218622272279",  # D405
    }
...
class FrankaEnv(gym.Env):
    ...
    def step_record(self, action: np.ndarray) -> tuple:
        ...
        return ob, int(reward), done, False, {"succeed": reward, "intervene_action": self.currpos}
    ...
    def _update_currpos(self):
        ...
        position = requests.post(self.url + "getposition").json() #[14,]
        gripper =  requests.post(self.url + "get_gripper").json() #[2,]
        ...
        self.currpos =np.array(position['position'][7:14])
        self.curr_gripper_pos=np.array(gripper['gripper'][1:2])
